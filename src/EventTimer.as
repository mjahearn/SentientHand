package
{
	...
	public class EventTimer extends FlxBasic
	{
		...
		public function EventTimer(_period:Number,_event:Function,_isLooped:Boolean=true,_isAutomatic:Boolean=true,_pulse:Function=null,_resetPulse:Function=null)
		{
			time = 0;
			direction = 1;
			period = _period;
